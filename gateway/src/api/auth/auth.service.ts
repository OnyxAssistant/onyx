...
import { NeuronsEventsService } from '@/neurons/neurons-events.service';
...
export class AuthService {
  ...
  constructor(
    private readonly neuronsEventsService: NeuronsEventsService,
  ...
  async useVerificationToken({ identifier, token }) {
    await this.neuronsEventsService.emitUserConnected(identifier);
